	...
	<body>
				...
				<div class="mother-grid-inner">
					...
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="index.html">后台首页</a><i class="fa fa-angle-right"></i>商品管理<i class="fa fa-angle-right"></i>商品列表</li>
					</ol>
								...
								<table id="table">
									...
									<tbody>
										<tr>
											...
											<td>165465132132</td>
											<td>123456</td>
											<td><button class="layui-btn layui-btn-radius layui-btn-normal">编辑</button>&nbsp;<button class="layui-btn layui-btn-radius layui-btn-danger">删除 </button></td>
		...
		<script>
            ...
            btn:['确定','取消'],
             ...
             layer.msg('删除成功',{icon:5,time:3000});	
             }
             });
