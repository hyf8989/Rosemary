				...
				<div class="mother-grid-inner">
					...
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="index.html">后台首页</a><i class="fa fa-angle-right"></i>商品管理<i class="fa fa-angle-right"></i>进货界面</li>
					</ol>
					<div class="agile3-grids">

						<div class="grid_3 grid_4 w3_agileits_icons_page">
							<div class="icons">
								<h2 class="agileits-icons-title">进货界面</h2><br /><br />
								<form action="" style="margin-bottom: 40%;">
								<div class="form-group">
										<label for="exampleInputAdminStatus">商品名称</label>
										<select class="form-control" name="exampleInputAdminStatus">
											<option>请选择</option>
											<option>粉百合</option>
											<option>明亮向日菊</option>
											<option>红玫瑰</option>
									...
									<div class="form-group">
										<label for="exampleInputPrice">商品库存:</label>
										<input type="text" class="form-control" id="exampleInputPrice" placeholder="">
									</div>
									<div class="form-group">
										<label for="exampleInputPrice">进货数量（单位：束）</label>
										<input type="text" class="form-control" id="exampleInputPrice" placeholder="">
									</div>
