				...
				<%@ include file="headnav.jsp" %>
					...
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="index.html">后台首页</a><i class="fa fa-angle-right"></i>管理员管理<i class="fa fa-angle-right"></i>管理员列表</li>
                ...
                <table class="layui-table ">
                    ...
                    <tbody>
                        <tr class="table-row">
							...
							<button class="layui-btn layui-btn-radius pwd-reset" style="margin-left: 20%;">重置密码</button>
                       ...
                       <tr class="table-row">
                        ...
                        <tr class="table-row">
                            ...
                            <td class="march">
                             ...
                             <td>
                          <button class="layui-btn layui-btn-radius" style="margin-left: 20%;">重置密码</button>
							<button class="layui-btn layui-btn-radius layui-btn-danger">锁定</button>
							<button class="layui-btn layui-btn-radius layui-btn-normal">解锁</button>
                            </td>
                        </tr>
...
<div class="dropdown">
		...
		<script>
            ...
            btn:['确定','取消'],
             ...
             layer.msg('成功释放用户权限',{icon:6,time:3000});	
             }
             });
			});
            ...
            btn:['确定','取消'],
             yes:function(index,layero){
             layer.msg('成功重置',{icon:6,time:3000});	
             }
             });
			});
