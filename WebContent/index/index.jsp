				...
				<div class="row">
					<div class="col-md-12">
						<div class="feature-tab wow fadeIn" data-wow-duration=".5s" data-wow-delay=".5s">
							<ul class="my-tab">
								<li class="active">
									<a data-toggle="tab" href="#new">最新</a>
								</li>
								<li>
									<a data-toggle="tab" href="#men">情人节</a>
								</li>
								<li>
									<a data-toggle="tab" href="#women">母亲节</a>
								</li>
								<li>
									<a data-toggle="tab" href="#kids">感恩节</a>
								</li>
							</ul>
								...
								<div id="women" class="tab-pane fade">
									<div class="tab-carousel">
										<div class="col-md-12">
											...
											<div class="single-product">
												<div class="single-product-img">
													<a href="#"><img src="img/singlepro/紫色桔梗.jpg" alt="" /></a>
													<span class="sale-box">
                                                            <span class="sale">Sale</span>
													</span>
												</div>
					...
					<div class="new-product wow fadeIn" data-wow-duration=".5s" data-wow-delay=".5s">
						<div class="new-carousel">
							...
							<div class="col-md-12">
								...
								<div class="single-product">
									<div class="single-product-img">
										<a href="#"><img src="img/singlepro/a23.jpg" alt="" /></a>
										<span class="sale-box">
                                                            <span class="sale">Sale</span>
										</span>
										<span class="new-box">
